...
def adm_compra():
    ...
    while True:
        try:
            ...
            OC1.vender(clientes[0], cantidad, vendedor1,
                       sucursal1, bodega1, OC1.despacho)
            break
        except Exception:
